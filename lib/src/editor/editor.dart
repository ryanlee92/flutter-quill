...
class QuillEditorState extends State<QuillEditor> implements EditorTextSelectionGestureDetectorBuilderDelegate {
  ...
  QuillEditorContextMenuBuilder? _buildContextMenuBuilder(bool showSelectionToolbar) {
    ...
    return (context, state) {
      ...
      return (config.contextMenuBuilder ?? QuillRawEditorConfig.defaultContextMenuBuilder)(context, state);
    };
  }
  ...
  EditorState get _requireEditorCurrentState {
    ...
    if (currentState == null) {
      throw StateError('The $EditorState is null, ensure the $_editorKey is associated correctly with $QuillRawEditor.');
    }
    return currentState;
  }
